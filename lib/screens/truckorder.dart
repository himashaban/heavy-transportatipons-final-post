                ...
                children: [
                  ...
                  DropdownButton(
                    ...
                    onChanged: (String? newValuee) {
                      setState(() {
                        sizevalue = newValuee!;
                        OrderCubit.get(context).getPriceInTruck(
                            fromvalue: fromvalue,
                            tovalue: tovalue
                        ) ;
                      });
...
///////////////Timepickerrrrrrrrr
                  ...
                  Container(
                    ...
                    child: Text(('Total price'
                        '               ${OrderCubit.get(context).priceTruck}')),
                  ),
                  SizedBox(
                    height: 30,
                  ),
